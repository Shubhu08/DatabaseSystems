...
SELECT InstructorName FROM instructor WHERE ClassName = 'JavaScript'
INTERSECT
SELECT InstructorName FROM instructor WHERE ClassName = 'Scratch'
INTERSECT
SELECT InstructorName FROM instructor WHERE ClassName = 'Python';
